...
/*
Wampify.prototype.broadcast = function(channelname, message) {
    if (_.isString(channel) && _.isArray(message)) {
        ...
        throw new TypeError('Wampify.broadcast accepts only a string and an array as arguments!');
    }
...
Wampify.prototype.subscribe = function(socket, channelname) {
    if ((socket instanceof WebSocket) && _.isString(channelname)) {
        ...
        throw new TypeError('Wampify.subscribe accepts only a socket and a string as arguments!');
    }
...
Wampify.prototype.unsubscribe = function(socket, channelname) {
    if ((socket instanceof WebSocket) && _.isString(channelname)) {
        ...
        throw new TypeError('Wampify.unsubscribe accepts only a socket and a string as arguments!');
    }
